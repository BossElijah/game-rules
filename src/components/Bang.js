  ...
  return (
    <>
      ...
      <p>
        ...
        pursuing his own goal! In BANG! each player plays one of these roles,
        and represents a famous Wild West inspired character.
      </p>
      ...
      <p>
        ...
        now announces the name of his character and reads his ability. Each
        player takes as many bullets as shown on his character.
      </p>
      <p>
      ...
      <p>
        Shuffle the playing cards, and give each player as many cards, face
        down, as the bullets he has. Put the remaining playing cards face down
        in the middle of the table, as a draw pile. Leave room for the discard
        pile.
      </p>

      <img src="/img/bang/game12.jpeg" alt="" />
      <p>
        <b>Note:</b> for your first few games, you can try a simplified version
        of the game by removing all cards with the symbol of a book before
        getting started.
      </p>

      <h4>Characters</h4>
      <p>
        Each Western character has some special abilities, which make you
        unique. The bullets you have show how many life points you begin the
        game with, i.e. how many times you can be hit before being eliminated
        from play.
      </p>
      <p>
      ...
      <p>
        If during game Jesse loses one life point and he is down at 3, he can
        only hold up to three cards in his hand at the end of his turn. But fear
        not! Life points can be recovered!
      </p>

      <h2>Game Play</h2>
      <p>
        The Sheriff begins. The game is played in turns, in clockwise order.
      ...
      <p>
        Now you may play cards to help yourself or hurt the other players,
        trying to eliminate them. You can only play cards during your turn
        (exception: Missed! and Beer, see below).
      </p>
      <p>
      ...
      <ul>
        ...
        <li>
          you can have only 1 copy of any one card in play; (one card is a copy
          of another if they have the same name)
        </li>
        <li>
          you can have only 1 weapon in play. (when you play a new weapon,
          discard the one you have in play)
        </li>
      </ul>
      <p>
        <i>Example:</i> If you put a Barrel in play, you cannot play another
        one, since you would end up having two copies of the same card in front
        of you.
      </p>
      <p>
      ...
      <p>
        <b>Blue-bordered cards</b> are played face up in front of you
        (exception: Jail). Blue cards in front of you are hence defined to be
        "in play".
      </p>
      <p>
        The effect of these cards lasts until they are discarded or removed
        somehow (e.g. through the play of a Cat Balou), or a special event
        occurs (e.g. in the case of Dynamite). There is no limit on the cards
        you can have in front of you provided that they do not share the same
        name.
      </p>
      <h2>3. Discard Excess Cards</h2>
      <p>
        Once the second phase is over (you do not want to or cannot play any
        more cards), then you must discard from your hand any cards exceeding
      ...
      <p>
        ...
        them, counting clockwise or counterclockwise (see figure). The distance
        is very important, because all cards with a sight take it into account.
      </p>
      <p>
        Normally you can reach only targets (players or cards) within a distance
        of 1 (note the <img src="/img/bang/game11.jpeg" alt="" /> of your Colt .45 on your
        playing board).
      </p>
      <p>
      ...
      <p>
        When you are eliminated from the game, show your role card and discard
        all the cards you have in hand and in play.
      </p>
      ...
      <ul>
        <li>
          <p>
            the Sheriff is killed. If the Renegade is the only one alive, then
            he wins. Otherwise, the Outlaws win;
          </p>
        </li>
        <li>
          <p>
      ...
      <p>
        ...
        and one Deputy and the Renegade are still in play. The game ends with
        the Outlaws winning! They achieved their goal at the cost of their own
        lives!
      </p>
      <h4>New Game</h4>
      <p>
        If you play more than one game in a row, players still "alive" at the
        end of the game may choose to keep their character (but not the cards in
        hand or in play!) for the following game; players which have been
      ...
      <p>
        Now that you are familiar with the rules, let's see the cards of BANG!
        in detail!
      </p>
      <h3>Remember</h3>
      <ul>
        ...
        <li>
          weapons do not change the distance between players, they represent
          only your shooting range
        </li>
        <li>
